        ...
        <div
            ...
            <p class="text-sm text-slate-600 dark:text-slate-300 font-medium">
                ...
                <?php if($reseller->phone): ?>
                    ...
                    <a href="tel:<?php echo e($reseller->phone); ?>"
                        class="text-primary hover:underline font-bold"><?php echo e($reseller->phone); ?></a>
                <?php endif; ?>
            </p>
        </div>
...
</html><?php /**PATH C:\Users\Bruce\Desktop\Projects\cloudtech\resources\views\reseller\store\disabled.blade.php ENDPATH**/ ?>