                        ...
                        <div class="mb-6 p-4 bg-rose-50 border border-rose-100 rounded-lg animate-in slide-in-from-top-2">
                            <ul class="list-disc list-inside space-y-1">
                                <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="text-[10px] font-bold text-rose-600 uppercase tracking-wider"><?php echo e($error); ?></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
                    <?php endif; ?>

                    <form method="POST" action="<?php echo e(route('register')); ?>" x-ref="registerForm" @submit.prevent="submit"
                        class="space-y-4">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="pt-2 text-center">
                            <p class="text-sm text-slate-500 dark:text-slate-400">
                                ...
                                <a href="<?php echo e(route('login')); ?>" class="text-primary font-bold hover:underline ml-1">Sign in
                                    instead</a>
                            </p>
                        </div>
                    </form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Bruce\Desktop\Projects\Megaai2\Megaai\cloudtech\resources\views/auth/register.blade.php ENDPATH**/ ?>