            ...
            <div class="grid gap-6 md:grid-cols-5">
                ...
                <div class="md:col-span-3">
                    <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm h-full overflow-hidden transition-colors duration-500"
                        ...
                        <div
                            class="p-6 border-b border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/50 flex justify-between items-center">
                            <div>
                                <h3 class="text-lg font-bold text-blue-900 dark:text-white"
                                    x-text="preselectedNetwork ? 'Buy ' + preselectedNetwork + ' Bundle' : 'Order Details'">
                                    Order Details</h3>
                                <p class="text-sm text-slate-500">Follow the steps to complete your purchase.</p>
                            </div>
                            <template x-if="preselectedNetwork">
                                <a href="<?php echo e(route('orders.new')); ?>"
                                    class="text-xs font-bold text-primary hover:underline">Change Network</a>
                            </template>
                        </div>
                        <div class="p-6">
                            <form @submit.prevent="handleSubmit" class="space-y-6">
                                ...
                                <div class="space-y-2" x-ref="step1" x-show="!preselectedNetwork">
                                    <label
                                ...
                                <div class="space-y-2 transition-all duration-300" x-ref="step2"
                                    ...
                                    <label
                                        class="text-sm font-semibold flex items-center gap-2 text-slate-700 dark:text-slate-300">
                                        <div class="w-6 h-6 bg-slate-100 dark:bg-slate-800 rounded-md flex items-center justify-center text-[10px] font-bold"
                                            x-text="preselectedNetwork ? '1' : '2'">
                                            2</div>
                                        Select Data Bundle
                                    </label>
            ...
            <script>
                document.addEventListener('alpine:init', () => {
                    Alpine.data('purchasePage', () => ({
                        ...
                        preselectedNetwork: '<?php echo e($preselectedNetwork ?? ''); ?>',
                        selectedNetwork: '<?php echo e($preselectedNetwork ?? ''); ?>',
                        selectedBundleId: '',
                        phone: '',
                        isLoading: false,
