...
<head>
    ...
    <title>Verification Required - <?php echo e(config('app.name')); ?></title>
...
<body class="bg-black text-white antialiased min-h-screen flex items-center justify-center p-4 md:p-6">
    ...
    <div class="relative w-full max-w-2xl z-10" x-data="{ requested: <?php echo e(session('success') ? 'true' : 'false'); ?> }">
        <!-- Main Card -->
        ...
        <div class="mt-6 sm:mt-8 flex justify-between items-center px-2 sm:px-4">
            ...
            <span class="font-mono text-[8px] sm:text-[9px] text-slate-500">ID:
                <?php echo e(strtoupper(substr(auth()->user()->id, 0, 8))); ?></span>
        </div>
    </div>
</body>

</html><?php /**PATH C:\Users\Bruce\Desktop\Projects\cloudtech\resources\views\auth\user-verify.blade.php ENDPATH**/ ?>