                ...
                <div
                    ...
                    <div
                        ...
                        <div class="relative min-w-[140px]">
                            <form action="<?php echo e(route('admin.notifications')); ?>" method="GET">
                                <select name="per_page" onchange="this.form.submit()"
                                    ...
                                    <?php $__currentLoopData = [5, 10, 20, 50, 100]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($val); ?>" <?php echo e(request('per_page', 5) == $val ? 'selected' : ''); ?>><?php echo e($val); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Bruce\Desktop\Projects\cloudtech\resources\views/admin/notifications/index.blade.php ENDPATH**/ ?>