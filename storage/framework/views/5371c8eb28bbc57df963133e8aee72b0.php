    ...
    <div class="flex items-center gap-3">
        ...
        <div class="relative" x-data="{ open: false }">
            <button @click="open = !open" @click.outside="open = false"
                ...
                <div
                    class="absolute top-2 right-2 w-2 h-2 rounded-full border-2 border-white dark:border-slate-800 <?php echo e($unreadCount > 0 ? 'bg-emerald-500' : 'bg-rose-500'); ?>">
                </div>
            </button>
...
</header><?php /**PATH C:\Users\bruce\OneDrive\Desktop\Projects\RocketDataHub\resources\views/components/admin-navbar.blade.php ENDPATH**/ ?>