...
<?php $__env->startSection('content'); ?>
    <div class="space-y-8 pb-20 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div x-data="{
            logoUrl: '<?php echo e(old('storefront_logo_url', $user->settings['storefront_logo_url'] ?? '')); ?>',
            title: '<?php echo e(old('storefront_title', $user->settings['storefront_title'] ?? ($user->store_name ?? $user->name) . '\'s Data Hub')); ?>',
            description: '<?php echo e(old('storefront_description', $user->settings['storefront_description'] ?? 'Select your preferred network and bundle size below to receive instant data delivery. Secure, fast, and reliable.')); ?>',
            themeColor: '<?php echo e(old('storefront_theme_color', $user->settings['storefront_theme_color'] ?? '#6366f1')); ?>',
            bgColor: '<?php echo e(old('storefront_bg_color', $user->settings['storefront_bg_color'] ?? '#0f172a')); ?>'
        }"
        class="bg-white dark:bg-slate-900 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 p-8 md:p-10 shadow-sm relative overflow-hidden">
            ...
            <div class="relative z-10 space-y-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    ...
                    <form action="<?php echo e(route('reseller.store.branding')); ?>" method="POST" class="space-y-6">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group/field">
                                    <input type="number" step="0.01" name="price"
                                        value="<?php echo e(number_format($bundle->custom_price, 2, '.', '')); ?>"
                                        min="<?php echo e(number_format($bundle->price, 2, '.', '')); ?>" required
                                ...
                                <p class="text-[9px] font-bold text-amber-500 mt-1.5 uppercase tracking-wider flex items-center gap-1">
                                    ...
                                    Min Retail Price: ₵<?php echo e(number_format($bundle->price, 2)); ?>
