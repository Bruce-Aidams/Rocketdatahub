    ...
    <div class="space-y-6 lg:space-y-8" x-data="{ 
                ...
                <div class="flex items-center gap-5 relative z-10">
                    ...
                    <div>
                        ...
                        <div class="text-3xl font-black text-slate-900 dark:text-white tracking-tight">
                            <?php echo e($announcements->total()); ?>
                        ...
                        <div class="text-lg font-black text-slate-900 dark:text-white tracking-tight mt-2">
                            ...
                            <?php if($active): ?>
                                <span
                                    ...
                                    <?php echo e(\Illuminate\Support\Str::limit($active->title, 20)); ?>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        class="font-bold text-sm text-slate-900 dark:text-white tracking-tight"><?php echo e($announcement->title); ?></span>
                                </td>
                                <td class="px-6 py-4 max-w-xs truncate">
                                    <span
                                        class="text-xs text-slate-500 dark:text-slate-400 font-medium"><?php echo e(\Illuminate\Support\Str::limit($announcement->message, 50)); ?></span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    ...
                                    ?>
                                    <span
                                        class="inline-flex items-center px-2.5 py-1 rounded-lg text-[10px] font-black uppercase tracking-widest border <?php echo e($typeColors[$announcement->type] ?? $typeColors['info']); ?>">
                                        <?php echo $typeIcon[$announcement->type] ?? $typeIcon['info']; ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <span
                                        class="text-xs font-bold text-slate-500 dark:text-slate-400"><?php echo e($announcement->created_at->format('M d, Y')); ?></span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        
                                        <form action="<?php echo e(route('admin.announcements.toggle', $announcement)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PATCH'); ?>
                                            <button type="submit"
                                                class="p-2 rounded-xl border transition-all duration-200 flex items-center justify-center <?php echo e($announcement->is_active ? 'bg-amber-50 text-amber-600 border-amber-200 hover:bg-amber-100 dark:bg-amber-500/10 dark:text-amber-400 dark:border-amber-500/20 dark:hover:bg-amber-500/20' : 'bg-emerald-50 text-emerald-600 border-emerald-200 hover:bg-emerald-100 dark:bg-emerald-500/10 dark:text-emerald-400 dark:border-emerald-500/20 dark:hover:bg-emerald-500/20'); ?>"
                                                title="<?php echo e($announcement->is_active ? 'Deactivate' : 'Activate'); ?>">
                                                <?php if($announcement->is_active): ?>
                                        ...
                                        <button type="button" @click="openEditModal(<?php echo e(json_encode($announcement)); ?>)"
        ...
        <div x-show="showCreateModal" class="fixed inset-0 z-[100] flex items-center justify-center p-4" x-cloak>
            ...
            <div class="relative w-full max-w-lg bg-white dark:bg-slate-900 rounded-3xl overflow-hidden shadow-2xl animate-in zoom-in-95 duration-200 border border-slate-100 dark:border-slate-800"
                ...
                <form action="<?php echo e(route('admin.announcements.store')); ?>" method="POST" class="p-6">
                    <?php echo csrf_field(); ?>
                    <div class="space-y-4">
                        <div>
                            <label
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Bruce\Desktop\Projects\cloudtech\resources\views\admin\announcements\index.blade.php ENDPATH**/ ?>