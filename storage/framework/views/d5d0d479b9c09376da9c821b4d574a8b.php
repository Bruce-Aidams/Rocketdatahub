...
<body class="bg-black text-white antialiased selection:bg-primary/30 min-h-screen flex items-center justify-center">
    ...
    <div class="fixed inset-0 opacity-20 pointer-events-none overflow-hidden">
        <svg width="100%" height="100%" class="absolute inset-0">
            ...
            <!-- Dynamic Nodes -->
            <?php for($i = 0; $i < 15; $i++): ?>
                <circle cx="<?php echo e(rand(5, 95)); ?>%" cy="<?php echo e(rand(5, 95)); ?>%" r="1.5" fill="#3b82f6" opacity="0.4">
                    <animate attributeName="opacity" values="0.1;0.5;0.1" dur="<?php echo e(rand(3, 7)); ?>s"
                        repeatCount="indefinite" />
                    <animate attributeName="r" values="1;2;1" dur="<?php echo e(rand(4, 9)); ?>s" repeatCount="indefinite" />
                </circle>
            <?php endfor; ?>
        </svg>
    </div>
    ...
    <div class="relative w-full max-w-7xl px-4 py-12 md:p-8 z-50 flex flex-col items-center justify-center min-h-screen"
        ...
        <div
            ...
            <p class="text-[7px] md:text-[8px] font-mono tracking-[0.3em] uppercase">Node: GH-0X<?php echo e(rand(100, 999)); ?></p>
        </div>
    </div>
</body>
