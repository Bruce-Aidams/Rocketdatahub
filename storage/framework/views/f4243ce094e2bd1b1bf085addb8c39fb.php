                            ...
                            <tr class="hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition-colors group">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <form action="<?php echo e(route('admin.users.toggle-verification', $u->id)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <button type="submit" title="<?php echo e($u->is_verified ? 'Unverify User' : 'Verify User'); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\bruce\OneDrive\Desktop\Projects\RocketDataHub\resources\views/admin/users/index.blade.php ENDPATH**/ ?>