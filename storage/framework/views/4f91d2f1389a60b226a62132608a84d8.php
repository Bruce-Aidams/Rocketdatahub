    ...
    <div class="flex flex-col min-h-screen bg-background dark:bg-slate-950 transition-colors duration-500">
        <main class="flex-1 pt-16">
            ...
            <section class="relative overflow-hidden py-16 md:py-24 lg:py-40">
                ...
                <?php if (isset($component)) { $__componentOriginal5dd5959aabd32c98f00ceeed9fd47fa4 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5dd5959aabd32c98f00ceeed9fd47fa4 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.hero-network-animation','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('hero-network-animation'); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal5dd5959aabd32c98f00ceeed9fd47fa4)): ?>
<?php $attributes = $__attributesOriginal5dd5959aabd32c98f00ceeed9fd47fa4; ?>
<?php unset($__attributesOriginal5dd5959aabd32c98f00ceeed9fd47fa4); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal5dd5959aabd32c98f00ceeed9fd47fa4)): ?>
<?php $component = $__componentOriginal5dd5959aabd32c98f00ceeed9fd47fa4; ?>
<?php unset($__componentOriginal5dd5959aabd32c98f00ceeed9fd47fa4); ?>
<?php endif; ?>
                                ...
                                <div
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div
                                            ...
                                            <span
                                                class="text-xs font-black uppercase tracking-widest"><?php echo e($product->network); ?></span>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="absolute top-3 left-3 md:top-4 md:left-4 z-20">
                                        <span
                                            class="px-2 py-1 md:px-3 md:py-1.5 rounded-lg md:rounded-xl text-[10px] md:text-xs font-black tracking-widest uppercase shadow-lg backdrop-blur-md <?php echo e($theme['bg']); ?> <?php echo e($theme['text']); ?>">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center gap-2 mt-2">
                                            <span
                                                ...
                                                <?php echo e($product->data_amount); ?>

                                            </span>
                                            <?php if($product->validity): ?>
                                                <span
                                                    class="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold bg-slate-100 dark:bg-slate-800 text-slate-500 uppercase tracking-wide">
                                                    <?php echo e($product->validity); ?>
