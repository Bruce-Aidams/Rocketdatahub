    ...
    <div class="container mx-auto px-4 sm:px-8 h-20 flex items-center justify-between">
        <a href="<?php echo e(url('/')); ?>" class="flex items-center gap-4 group">
            <div
                ...
                <img src="<?php echo e(asset('logo.png')); ?>" alt="Logo" class="w-8 h-8 relative z-10">
            </div>
            <span
...
</header><?php /**PATH C:\Users\bruce\OneDrive\Desktop\Projects\RocketDataHub\resources\views/partials/navbar.blade.php ENDPATH**/ ?>