...
<div class="auth-viewport" x-data="{
    ...
    <div class="w-full max-w-[440px] flex items-center justify-between px-2 mb-6">
        <a href="<?php echo e(url('/')); ?>" class="w-10 h-10 rounded-full bg-white dark:bg-slate-900 shadow-sm flex items-center justify-center border border-slate-100 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
    ...
    <div class="auth-mobile-card">
        ...
        <div class="flex bg-slate-100 dark:bg-slate-800 rounded-2xl p-1 mb-8">
            <a href="<?php echo e(route('login')); ?>" class="auth-tab-pill bg-white dark:bg-slate-700 shadow-sm text-primary">Login</a>
            <a href="<?php echo e(route('register')); ?>" class="auth-tab-pill text-slate-400 dark:text-slate-500 hover:text-slate-650">Sign Up</a>
        </div>

        
        <?php if(session('error')): ?>
            <div class="mb-4 p-4 bg-rose-50 dark:bg-rose-950/20 border border-rose-100 dark:border-rose-900/30 rounded-2xl text-xs font-bold text-rose-600 dark:text-rose-400 uppercase tracking-wider"><?php echo e(session('error')); ?></div>
        <?php endif; ?>
        <?php if($errors->any()): ?>
            <div class="mb-4 p-4 bg-rose-50 dark:bg-rose-950/20 border border-rose-100 dark:border-rose-900/30 rounded-2xl text-xs font-bold text-rose-600 dark:text-rose-400 uppercase tracking-wider"><?php echo e($errors->first()); ?></div>
        <?php endif; ?>

        <form method="POST" action="<?php echo e(route('login')); ?>" x-ref="loginForm" @submit.prevent="submit" class="space-y-4">
            <?php echo csrf_field(); ?>
            ...
            <div class="auth-input-group">
                ...
                <div class="auth-input-wrapper">
                    ...
                    <input id="login" type="text" name="login" value="<?php echo e(old('login')); ?>"
            ...
            <div class="auth-input-group">
                <div class="flex justify-between items-center pr-1">
                    ...
                    <?php if(Route::has('password.request')): ?>
                        <a href="<?php echo e(route('password.request')); ?>" class="text-[10px] font-black text-primary hover:underline uppercase tracking-wider">Forgot?</a>
                    <?php endif; ?>
                </div>
                <div class="auth-input-wrapper">
                    <span class="auth-input-icon-left">
            ...
            <div class="pt-2">
                ...
                <div class="flex justify-center items-center gap-4">
                    <a href="<?php echo e(route('google.login')); ?>" class="w-12 h-12 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm flex items-center justify-center hover:bg-slate-50 dark:hover:bg-slate-700 transition-all">
    ...
    <!-- <div class="auth-bottom-nav">
        <a href="<?php echo e(url('/')); ?>" class="auth-bottom-nav-item">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
            </svg>
            <span>Home</span>
        </a>
        <a href="<?php echo e(url('/#features')); ?>" class="auth-bottom-nav-item">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 12h16M4 18h16" />
            </svg>
            <span>Services</span>
        </a>
        <a href="<?php echo e(route('orders.new')); ?>" class="auth-bottom-nav-book-btn">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
            </svg>
        </a>
        <a href="<?php echo e(url('/#pricing')); ?>" class="auth-bottom-nav-item">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
            </svg>
            <span>Shop</span>
        </a>
        <a href="<?php echo e(route('dashboard')); ?>" class="auth-bottom-nav-item active">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\bruce\OneDrive\Desktop\Projects\RocketDataHub\resources\views/auth/login.blade.php ENDPATH**/ ?>