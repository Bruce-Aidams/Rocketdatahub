    ...
    <div class="auth-card">
        ...
        <div class="auth-left">
            ...
            <div class="auth-brand-copy">
                <h1 class="auth-heading">Sign In to<br><?php echo e(config('app.name')); ?></h1>
                <p class="auth-subtext">
                    If you don't have an account<br>
                    you can <a href="<?php echo e(route('register')); ?>" class="auth-link-blue">Register here!</a>
                </p>
            </div>
        </div>
        ...
        <div class="auth-right">
            ...
            <?php if(session('error')): ?>
                <div class="auth-alert auth-alert-error"><?php echo e(session('error')); ?></div>
            <?php endif; ?>
            <?php if($errors->any()): ?>
                <div class="auth-alert auth-alert-error"><?php echo e($errors->first()); ?></div>
            <?php endif; ?>

            <form method="POST" action="<?php echo e(route('login')); ?>" x-ref="loginForm" @submit.prevent="submit" class="auth-form">
                <?php echo csrf_field(); ?>
                ...
                <?php if(Route::has('password.request')): ?>
                    <div class="auth-recover">
                        <a href="<?php echo e(route('password.request')); ?>" class="auth-recover-link">Recover Password ?</a>
                    </div>
                <?php endif; ?>
                ...
                <div class="auth-social-row">
                    <a href="<?php echo e(route('google.login')); ?>" class="auth-social-btn" title="Google">
                    ...
                    <a href="<?php echo e(url('/')); ?>" class="auth-social-btn auth-social-apple" title="Apple">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/>
                        </svg>
                    </a>
                    <a href="<?php echo e(url('/')); ?>" class="auth-social-btn auth-social-facebook" title="Facebook">
