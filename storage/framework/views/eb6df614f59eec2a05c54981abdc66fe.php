...
<div class="auth-viewport" x-data="{
    ...
    <div class="auth-mobile-card my-6">
        ...
        <div class="flex bg-slate-100 dark:bg-slate-800 rounded-2xl p-1 mb-8">
            <a href="<?php echo e(route('login')); ?>" class="auth-tab-pill text-slate-400 dark:text-slate-500 hover:text-slate-650">Login</a>
            <a href="<?php echo e(route('register')); ?>" class="auth-tab-pill bg-white dark:bg-slate-700 shadow-sm text-primary">Sign Up</a>
        </div>
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>" x-ref="registerForm" @submit.prevent="submit" class="space-y-4">
            <?php echo csrf_field(); ?>
            ...
            <div class="auth-input-group">
                ...
                <div class="auth-input-wrapper">
                    ...
                    <input id="referral_code" type="text" name="referral_code" value="<?php echo e(old('referral_code')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\bruce\OneDrive\Desktop\Projects\RocketDataHub\resources\views/auth/register.blade.php ENDPATH**/ ?>