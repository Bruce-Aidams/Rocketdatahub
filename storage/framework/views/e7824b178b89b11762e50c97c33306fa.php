...
<body class="antialiased bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 min-h-screen relative">
    ...
    <div x-data="purchasePage">
        ...
        <div
            ...
            <a href="<?php echo e(route('store.show', $reseller->referral_code)); ?>"
                ...
                <div class="md:col-span-3">
                    <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm h-full overflow-hidden transition-colors duration-500"
                        ...
                        <div
                            ...
                            <p class="text-sm text-slate-500">Managed by <?php echo e($reseller->store_name ?? $reseller->name); ?>
    ...
    <form id="paystack-form" action="<?php echo e(route('store.purchase')); ?>" method="POST" style="display: none;">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="reseller_code" value="<?php echo e($reseller->referral_code); ?>">
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('purchasePage', () => ({
                ...
                selectedNetwork: '<?php echo e($network); ?>',
                selectedBundleId: '',
                phone: '',
                email: '',
                isLoading: false,
...
</html><?php /**PATH C:\Users\Bruce\Desktop\Projects\Megaai2\Megaai\cloudtech\resources\views/reseller/store/buy.blade.php ENDPATH**/ ?>