...
@section('content')
    <div class="space-y-10">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <form action="{{ route('admin.profit') }}" method="GET"
        ...
        <div class="grid gap-8 lg:grid-cols-4">
            ...
            <div class="lg:col-span-3 grid gap-6 grid-cols-1 md:grid-cols-3">
                ...
                @forelse($networkProfits as $netProfit)
                    @php
                    ...
                    @endphp
                    <div
                        class="p-8 rounded-[2rem] bg-gradient-to-br {{ $color['bg'] }} {{ $color['text'] }} shadow-xl transition-all hover:-translate-y-2 relative overflow-hidden group">
                        <div
                        ...
                        <div class="relative z-10">
                            <h5 class="text-[10px] font-black uppercase tracking-[0.3em] opacity-70 mb-2">{{ $color['label'] }}
                                Network Profit</h5>
                            <p class="text-3xl font-black tabular-nums">GHS {{ number_format($netProfit->total_profit, 2) }}</p>
                            ...
                            <div class="mt-8 pt-6 border-t border-black/5 flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-sm font-bold">{{ $netProfit->order_count }} Orders</p>
                                </div>
            ...
            <div
                ...
                <div class="relative z-10">
                    ...
                    <h4 class="text-4xl font-black tabular-nums tracking-tighter">GHS
                        {{ number_format($totalProfitInRange, 2) }}
                    </h4>
                    <p
                            ...
                            <tr class="hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition-all group">
                                <td class="px-10 py-6">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p class="text-sm font-black text-slate-900 dark:text-white">{{ $up->name }}</p>
                                            <p class="text-[11px] text-slate-400 font-medium">{{ $up->email }}</p>
                                        </div>
                                    </div>
                                </td>
