        ...
        <div class="details-box">
            <table class="info-table">
                <tr>
                    ...
                    <td style="text-align: right;">
                        ...
                        <div class="info-value">{{ $transaction->created_at->format('M d, Y') }}</div>
            ...
            <table class="items-table">
                ...
                <tbody>
                    <tr>
                        <td>
                            <strong>{{ $transaction->description ?? 'Data Bundle Purchase' }}</strong><br>
                            <span style="font-size: 11px; color: #64748b;">Ref: {{ $transaction->reference }}</span>
                        </td>
